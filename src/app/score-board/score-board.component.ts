...
export class ScoreBoardComponent implements OnInit {
  ...
  constructor(private apiService:ApiService, private storage:LocalStorageService,public dialog: MatDialog,
    ) { }

  userEmail = this.storage.retrieve('email');
  ...
  getMatchDetails(matchID:any,teamTitle:any){
    const dialogRef = this.dialog.open(IndividualMatchScoreComponent, {data:{'matchID':matchID,'teamTitel':teamTitle}});
  }
}
